...
vd_oral_phylum = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_phylum, file = "data_analysis/oral_microbiome/ICC/vd_oral_phylum")
...
vd_oral_order = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_order, file = "data_analysis/oral_microbiome/ICC/vd_oral_order")
...
vd_oral_genus = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_genus, file = "data_analysis/oral_microbiome/ICC/vd_oral_genus")
...
vd_oral_family = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_family, file = "data_analysis/oral_microbiome/ICC/vd_oral_family")
...
vd_oral_class = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_class, file = "data_analysis/oral_microbiome/ICC/vd_oral_class")
...
vd_oral_asv = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/oral_microbiome/ICC/")
save(vd_oral_asv, file = "data_analysis/oral_microbiome/ICC/vd_oral_asv")
