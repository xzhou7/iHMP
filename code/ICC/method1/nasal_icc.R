...
vd_nasal_phylum = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_phylum, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_phylum")
...
vd_nasal_order = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_order, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_order")
...
vd_nasal_genus = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_genus, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_genus")
...
vd_nasal_family = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_family, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_family")
...
vd_nasal_class = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_class, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_class")
...
vd_nasal_asv = myVD(ds = ds, trans = "Arcsin")
dir.create("data_analysis/nasal_microbiome/ICC/")
save(vd_nasal_asv, file = "data_analysis/nasal_microbiome/ICC/vd_nasal_asv")
