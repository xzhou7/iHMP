...
dir.create(
  "data_analysis/combine_microbiome/within_subject_distance_by_sample/nasal/",
  recursive = TRUE
)
setwd("data_analysis/combine_microbiome/within_subject_distance_by_sample/nasal/")
...
# 
# tax_table = as.data.frame(tax_table(physeq_nasal))
# otu_table = otu_table(physeq_nasal)
# sample_data = as.data.frame(sample_data(physeq_nasal))
# 
# new_otu_table <-
...
# 
# save(nasal_braydist_by_sample,
#      file = "nasal_braydist_by_sample",
#      compress = "xz")

load("nasal_braydist_by_sample")
...
# save(nasal_subject_id, file = "nasal_subject_id")
