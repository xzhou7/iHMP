...
dir.create(
  "data_analysis/combine_microbiome/within_subject_distance_by_sample/oral/",
  recursive = TRUE
)
setwd("data_analysis/combine_microbiome/within_subject_distance_by_sample/oral/")
...
# 
# tax_table = as.data.frame(tax_table(physeq_oral))
# otu_table = otu_table(physeq_oral)
# sample_data = as.data.frame(sample_data(physeq_oral))
# 
# new_otu_table <-
...
# 
# save(oral_braydist_by_sample,
#      file = "oral_braydist_by_sample",
#      compress = "xz")

load("oral_braydist_by_sample")
...
save(oral_subject_id, file = "oral_subject_id")
