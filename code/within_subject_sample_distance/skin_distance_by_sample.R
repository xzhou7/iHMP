...
dir.create(
  "data_analysis/combine_microbiome/within_subject_distance_by_sample/skin/",
  recursive = TRUE
)
setwd("data_analysis/combine_microbiome/within_subject_distance_by_sample/skin/")
...
# 
# tax_table = as.data.frame(tax_table(physeq_skin))
# otu_table = otu_table(physeq_skin)
# sample_data = as.data.frame(sample_data(physeq_skin))
# 
# new_otu_table <-
...
# 
# rowSums(new_otu_table)
# 
# dim(new_otu_table)
# 
# plot(rowSums(new_otu_table))
# sum(rowSums(new_otu_table) == 0)
# 
# plot(colSums(new_otu_table))
# sum(colSums(new_otu_table) == 0)
# 
...
# 
# save(skin_braydist_by_sample,
#      file = "skin_braydist_by_sample",
#      compress = "xz")

load("skin_braydist_by_sample")
...
save(skin_subject_id, file = "skin_subject_id")
...
ggsave(plot1, filename = "total_plot.pdf", width = 11, height = 7)
ggsave(plot2, filename = "each_plot.pdf", width = 12, height = 10)
