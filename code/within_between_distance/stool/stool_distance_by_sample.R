...
dir.create("data_analysis/combine_microbiome/distance/stool_by_sample/")
setwd("data_analysis/combine_microbiome/distance/stool_by_sample/")
...
subdat2 = prune_taxa(taxa_sums(physeq_stool) > 0, physeq_stool)
