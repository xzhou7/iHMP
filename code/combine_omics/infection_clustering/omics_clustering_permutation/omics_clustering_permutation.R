...
openxlsx::write.xlsx(
  cluster1,
  "data_analysis/combine_omics/clustering/cluster_1/cluster1_with_p_value.xlsx"
)
...
openxlsx::write.xlsx(
  cluster2,
  "data_analysis/combine_omics/clustering/cluster_2/cluster2_with_p_value.xlsx"
)
...
openxlsx::write.xlsx(
  cluster3,
  "data_analysis/combine_omics/clustering/cluster_3/cluster3_with_p_value.xlsx"
)
