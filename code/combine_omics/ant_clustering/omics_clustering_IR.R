...
###stool
{
  load("data_analysis/stool_microbiome/clustering/Ant_phylum_IR/new_expression_data")
  load("data_analysis/stool_microbiome/clustering/Ant_phylum_IR/new_sample_info")
  load("data_analysis/stool_microbiome/clustering/Ant_phylum_IR/new_variable_info")
  
  temp_data <-
    unique(new_sample_info$class) %>%
    purrr::map(function(x) {
      new_expression_data[, which(new_sample_info$class == x), drop = FALSE] %>%
        apply(1, mean)
    }) %>%
    do.call(cbind, .) %>%
    as.data.frame()
...
###skin
{
  load("data_analysis/skin_microbiome/clustering/Ant_phylum_IR/new_expression_data")
  load("data_analysis/skin_microbiome/clustering/Ant_phylum_IR/new_sample_info")
  load("data_analysis/skin_microbiome/clustering/Ant_phylum_IR/new_variable_info")
...
###nasal
{
  load("data_analysis/nasal_microbiome/clustering/Ant_phylum_IR/new_expression_data")
  load("data_analysis/nasal_microbiome/clustering/Ant_phylum_IR/new_sample_info")
  load("data_analysis/nasal_microbiome/clustering/Ant_phylum_IR/new_variable_info")
...
###oral
{
  load("data_analysis/oral_microbiome/clustering/Ant_phylum_IR/new_expression_data")
  load("data_analysis/oral_microbiome/clustering/Ant_phylum_IR/new_sample_info")
  load("data_analysis/oral_microbiome/clustering/Ant_phylum_IR/new_variable_info")
...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/combine_omics/Ant_clustering_IR",
           recursive = TRUE)
setwd("data_analysis/combine_omics/Ant_clustering_IR")
