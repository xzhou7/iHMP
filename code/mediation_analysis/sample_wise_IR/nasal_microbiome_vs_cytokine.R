...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/nasal_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/nasal_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/nasal_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/cytokine_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/cytokine_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/cytokine_sample_info"
  )
}
...
###finally, for nasal microbiome, 69 genus, for cytokine, 66 cytokines
###621 samples
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/nasal_microbiome_vs_cytokine/nasal_microbiome_cytokine_lm_adjusted_cor_spearman"
)

nasal_microbiome_cytokine_cor <-
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/cytokine_vs_phenotype_sample_wise/cytokine_phenotype_lm_adjusted_cor_spearman"
)
...
dim(nasal_microbiome_cytokine_cor)
dim(nasal_microbiome_phenotype_cor)

unique(nasal_microbiome_cytokine_cor$microbiome)
...
setwd(masstools::get_project_wd())
dir.create(
  "data_analysis/mediation_analysis/sample_wise_IR/nasal_microbiome_vs_cytokine",
  recursive = TRUE
)
setwd("data_analysis/mediation_analysis/sample_wise_IR/nasal_microbiome_vs_cytokine")

###here we use the lm_adjusted_cor
sum(nasal_microbiome_cytokine_cor$p_adjust < 0.2)
...
for(i in 1:nrow(nasal_microbiome_cytokine_cor)) {
  cat(i, "\n")
  microbiome_id = nasal_microbiome_cytokine_cor$microbiome[i]
  internal_ome_id = nasal_microbiome_cytokine_cor$metabolite[i]
...
mediation_result <-
mediation_result %>%
  dplyr::left_join(nasal_microbiome_cytokine_lm_adjusted_cor_spearman %>% dplyr::select(-p_adjust2),
