...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/skin_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/skin_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/skin_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/metabolome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/metabolome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/metabolome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_metabolome/skin_microbiome_metabolome_lm_adjusted_cor_spearman"
)
...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/mediation_analysis/sample_wise_IR/skin_microbiome_vs_metabolome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IR/skin_microbiome_vs_metabolome")
