...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/skin_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/skin_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/skin_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/cytokine_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/cytokine_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/cytokine_sample_info"
  )
}
...
###finally, for skin microbiome, 69 genus, for cytokine, 66 cytokines
###621 samples
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/skin_microbiome_vs_cytokine/skin_microbiome_cytokine_lm_adjusted_cor_spearman"
)

skin_microbiome_cytokine_cor <-
...
dim(skin_microbiome_cytokine_cor)
dim(skin_microbiome_phenotype_cor)

unique(skin_microbiome_cytokine_cor$microbiome)
...
masstools::setwd_project()
dir.create(
  "data_analysis/mediation_analysis/sample_wise_IR/skin_microbiome_vs_cytokine",
  recursive = TRUE
)
setwd("data_analysis/mediation_analysis/sample_wise_IR/skin_microbiome_vs_cytokine")

###here we use the lm_adjusted_cor
sum(skin_microbiome_cytokine_cor$p_adjust < 0.2)
...
for(i in 1:nrow(skin_microbiome_cytokine_cor)) {
  cat(i, "\n")
  microbiome_id = skin_microbiome_cytokine_cor$microbiome[i]
  internal_ome_id = skin_microbiome_cytokine_cor$metabolite[i]
...
mediation_result <-
mediation_result %>%
  dplyr::left_join(skin_microbiome_cytokine_lm_adjusted_cor_spearman %>% dplyr::select(-p_adjust2),
