...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/oral_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/oral_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/oral_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/cytokine_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/cytokine_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/cytokine_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine/oral_microbiome_cytokine_lm_adjusted_cor_spearman"
)
...
masstools::setwd_project()
dir.create(
  "data_analysis/mediation_analysis/sample_wise_IR/oral_microbiome_vs_cytokine",
  recursive = TRUE
)
setwd("data_analysis/mediation_analysis/sample_wise_IR/oral_microbiome_vs_cytokine")
