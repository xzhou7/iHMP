...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/stool_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/stool_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/stool_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/lipidome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/lipidome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/lipidome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_lipidome/stool_microbiome_lipidome_lm_adjusted_cor_spearman"
)

stool_microbiome_lipidome_cor <- 
...
dim(stool_microbiome_lipidome_cor)
dim(stool_microbiome_phenotype_cor)

unique(stool_microbiome_lipidome_cor$microbiome)
unique(stool_microbiome_phenotype_cor$microbiome)

intersect_id <- 
  intersect(unique(stool_microbiome_lipidome_cor$microbiome),
            unique(stool_microbiome_phenotype_cor$microbiome))
...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/mediation_analysis/sample_wise_IR/stool_microbiome_vs_lipidome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IR/stool_microbiome_vs_lipidome")

###here we use the lm_adjusted_cor
sum(stool_microbiome_lipidome_cor$p_adjust < 0.2)
...
for(i in 1:nrow(stool_microbiome_lipidome_cor)) {
  cat(i, "\n")
  microbiome_id = stool_microbiome_lipidome_cor$microbiome[i]
  internal_ome_id = stool_microbiome_lipidome_cor$metabolite[i]
...
mediation_result <-
mediation_result %>%
  dplyr::left_join(stool_microbiome_lipidome_lm_adjusted_cor_spearman %>% dplyr::select(-p_adjust2),
