...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/stool_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/stool_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/stool_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/proteome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/proteome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/proteome_sample_info"
  )
}
...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_phenotype_sample_wise/phenotype_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_phenotype_sample_wise/phenotype_sample_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_phenotype_sample_wise/phenotype_variable_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_proteome/stool_microbiome_proteome_lm_adjusted_cor_spearman"
)

stool_microbiome_proteome_cor <- 
  stool_microbiome_proteome_lm_adjusted_cor_spearman %>% 
  dplyr::filter(p_adjust < 0.2)

load(
  "data_analysis/correlation_network/whole_data_set_IR/stool_microbiome_vs_phenotype_sample_wise/stool_microbiome_phenotype_lm_adjusted_cor_spearman"
)
...
dim(stool_microbiome_proteome_cor)
dim(stool_microbiome_phenotype_cor)

unique(stool_microbiome_proteome_cor$microbiome)
unique(stool_microbiome_phenotype_cor$microbiome)

intersect_id <- 
  intersect(unique(stool_microbiome_proteome_cor$microbiome),
            unique(stool_microbiome_phenotype_cor$microbiome))
...
######work directory
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise_IR/stool_microbiome_vs_proteome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IR/stool_microbiome_vs_proteome")

###here we use the lm_adjusted_cor
sum(stool_microbiome_proteome_cor$p_adjust < 0.2)
...
for(i in 1:nrow(stool_microbiome_proteome_cor)) {
  cat(i, "\n")
  microbiome_id = stool_microbiome_proteome_cor$microbiome[i]
  internal_ome_id = stool_microbiome_proteome_cor$metabolite[i]
...
mediation_result <-
mediation_result %>%
  dplyr::left_join(stool_microbiome_proteome_lm_adjusted_cor_spearman %>% dplyr::select(-p_adjust2),
...
plot <-
  ...
  geom_node_point(aes(fill = class1,
                  ...
                  shape = 21,
                  show.legend = TRUE) +
  scale_fill_manual(values = c(omics_color[c("Stool microbiome", "Proteome")], phenotype_color)) +
  scale_color_manual(values = c(omics_color[c("Stool microbiome", "Proteome")], phenotype_color)) +
  geom_node_text(
    aes(
      x = x * 1.05,
      y = y * 1,
