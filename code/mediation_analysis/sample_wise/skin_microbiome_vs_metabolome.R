...
{
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/skin_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/skin_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/skin_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/metabolome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/metabolome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/metabolome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_metabolome/skin_microbiome_metabolome_lm_adjusted_cor_spearman"
)
...
######work directory
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_metabolome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_metabolome")
...
plot <-
  ...
  geom_node_point(aes(fill = class1,
                  ...
                  show.legend = TRUE) +
  scale_fill_manual(
    values = c(omics_color[c("Skin microbiome", "Metabolome")], phenotype_color)
  ) +
  scale_color_manual(
    values = c(omics_color[c("Skin microbiome", "Metabolome")], phenotype_color)
  ) +
