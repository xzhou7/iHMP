...
####stool microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05 & prop_mediate < 1)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/stool_microbiome_vs_metabolome/mediation_result_inverse")
...
####skin microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/skin_microbiome_vs_metabolome/mediation_result_inverse")
...
####oral microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/oral_microbiome_vs_metabolome/mediation_result_inverse")
...
####nasal microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_metabolome/mediation_result_inverse")
...
ggsave(plot, filename = "sankey_plot_2.pdf", width = 7, height = 7)
