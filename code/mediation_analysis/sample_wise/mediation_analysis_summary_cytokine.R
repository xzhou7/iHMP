...
sum(mediation_result$treat_true_name == "Eggerthella")


dim(mediation_result)
write.csv(mediation_result, "mediation_result_cytokine.csv", row.names = FALSE)
...
ggsave(plot, filename = "mediation_analysis_cytokine.pdf", width = 7, height = 7)
