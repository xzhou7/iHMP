...
{
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/nasal_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/nasal_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/nasal_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/cytokine_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/cytokine_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/cytokine_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_cytokine/nasal_microbiome_cytokine_lm_adjusted_cor_spearman"
)
...
setwd(masstools::get_project_wd())
dir.create(
  "data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_cytokine",
  recursive = TRUE
)
setwd("data_analysis/mediation_analysis/sample_wise/nasal_microbiome_vs_cytokine")
