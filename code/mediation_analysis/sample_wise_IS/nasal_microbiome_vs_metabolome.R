...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/nasal_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/nasal_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/nasal_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/metabolome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/metabolome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/metabolome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_metabolome/nasal_microbiome_metabolome_lm_adjusted_cor_spearman"
)
...
######work directory
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_metabolome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_metabolome")
