...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/oral_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/oral_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/oral_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/proteome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/proteome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/proteome_sample_info"
  )
}
...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_phenotype_sample_wise/phenotype_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_phenotype_sample_wise/phenotype_sample_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_phenotype_sample_wise/phenotype_variable_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_proteome/oral_microbiome_proteome_lm_adjusted_cor_spearman"
)
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/oral_microbiome_vs_phenotype_sample_wise/oral_microbiome_phenotype_lm_adjusted_cor_spearman"
)
...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_proteome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_proteome")
