...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/nasal_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/nasal_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/nasal_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/lipidome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/lipidome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/lipidome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/nasal_microbiome_vs_lipidome/nasal_microbiome_lipidome_lm_adjusted_cor_spearman"
)

nasal_microbiome_lipidome_cor <- 
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/lipidome_vs_phenotype_sample_wise/lipidome_phenotype_lm_adjusted_cor_spearman"
)
...
dim(nasal_microbiome_lipidome_cor)
dim(nasal_microbiome_phenotype_cor)

unique(nasal_microbiome_lipidome_cor$microbiome)
unique(nasal_microbiome_phenotype_cor$microbiome)

intersect_id <- 
intersect(unique(nasal_microbiome_lipidome_cor$microbiome),
          unique(nasal_microbiome_phenotype_cor$microbiome))
...
######work directory
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_lipidome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_lipidome")

###here we use the lm_adjusted_cor
sum(nasal_microbiome_lipidome_cor$p_adjust < 0.2)
...
for(i in 1:nrow(nasal_microbiome_lipidome_cor)) {
  cat(i, "\n")
  microbiome_id = nasal_microbiome_lipidome_cor$microbiome[i]
  internal_ome_id = nasal_microbiome_lipidome_cor$metabolite[i]
...
mediation_result <-
mediation_result %>%
  dplyr::left_join(nasal_microbiome_lipidome_lm_adjusted_cor_spearman %>% dplyr::select(-p_adjust2),
...
save(mediation_result_inverse, file = "mediation_result_inverse")
 ...
 plot <-
   ...
   geom_node_point(aes(fill = class1,
                   ...
                   shape = 21,
                   show.legend = TRUE) +
   scale_fill_manual(values = c(omics_color[c("Nasal microbiome", "Cytokine")], phenotype_color)) +
   scale_color_manual(values = c(omics_color[c("Nasal microbiome", "Cytokine")], phenotype_color)) +
   geom_node_text(
     aes(
       x = x * 1.05,
       y = y * 1,
