...
{
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/skin_microbiome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/skin_microbiome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/skin_microbiome_sample_info"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/proteome_expression_data"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/proteome_variable_info"
  )
  load(
    "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/proteome_sample_info"
  )
}
...
load(
  "data_analysis/correlation_network/whole_data_set_IS/skin_microbiome_vs_proteome/skin_microbiome_proteome_lm_adjusted_cor_spearman"
)
...
######work directory
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_proteome",
           recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_proteome")
