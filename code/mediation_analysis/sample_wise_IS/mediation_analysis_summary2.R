...
####stool microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05 & prop_mediate < 1)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/stool_microbiome_vs_metabolome/mediation_result_inverse")
...
####skin microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/skin_microbiome_vs_metabolome/mediation_result_inverse")
...
####oral microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/oral_microbiome_vs_metabolome/mediation_result_inverse")
...
####nasal microbiome
####cytokine
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_cytokine/mediation_result")
mediation_result <-
  mediation_result %>% 
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_cytokine/mediation_result_inverse")
...
####proteome
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_proteome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_proteome/mediation_result_inverse")
...
####lipidome
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_lipidome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_lipidome/mediation_result_inverse")
...
####metabolome
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_metabolome/mediation_result")
mediation_result <-
  mediation_result %>%
  dplyr::filter(prop_mediate > 0 & acme_p < 0.05)
dim(mediation_result)
load("data_analysis/mediation_analysis/sample_wise_IS/nasal_microbiome_vs_metabolome/mediation_result_inverse")
...
masstools::setwd_project()
dir.create("data_analysis/mediation_analysis/sample_wise_IS/summary", recursive = TRUE)
setwd("data_analysis/mediation_analysis/sample_wise_IS/summary")
mediation_result <-
...
mediation_result$phenotype_class <- clinical.class$Class[match(mediation_result$phenotype_true_name, clinical.class$Abbreviation)] 
...
plot <- ggplot(temp_data,
  ...
  scale_fill_manual(values = c(omics_color, phenotype_class_color)) +
